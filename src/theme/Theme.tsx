...
const Theme: FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	const { storage, addLocalStorage } = useLocalStorage<SettingThemeLocalstorage>('triolo-settings')
	...
	const changePrimaryColor = (primaryColor: typeof themeSetting.primaryColor) => {
	...
	const handleAppBarPosition = (position: typeof themeSetting.layout.appBarPosition) => {
		setThemeSetting((prevState) => ({
			...prevState,
			layout: {
				...prevState.layout,
	...
	const handleAppFooterPosition = (position: typeof themeSetting.layout.footerPosition) => {
		setThemeSetting((prevState) => ({
			...prevState,
			layout: {
				...prevState.layout,
	...
	const handleChangeMenuLayout = (layout: typeof themeSetting.menuStyle.layout) => {
		setThemeSetting((prevState) => ({
			...prevState,
			menuStyle: {
				...prevState.menuStyle,
	...
	const handleChangeMenuOpenStyle = (style: typeof themeSetting.menuStyle.openStyle) => {
		setThemeSetting((prevState) => ({
			...prevState,
			menuStyle: {
				...prevState.menuStyle,
