...
const getTabItems = (container: HTMLDivElement): NodeListOf<HTMLButtonElement> =>
...
const rightScrollItem = (nodes: NodeListOf<HTMLButtonElement>, xWidth: number) => {
	let x = null
...
const leftScrollItem = (nodes: NodeListOf<HTMLButtonElement>, xWidth: number) => {
	let x = null
