...
import { ChoiceWrapper, ChoiceCircle, Dot, CirclePlaceholder } from './choice.styled'
import { ChoiceProps } from './type'
import Text from '../text/Text'
import useTheme from '../../theme/useTheme'

const Choice: FC<ChoiceProps> = ({ label, name, onChange, value, selected }) => {
		...
		<ChoiceWrapper onClick={handleChoice}>
			<ChoiceCircle theme={theme} selected={isSelected}>
				...
				<input
					...
					value={value}
				/>
				<CirclePlaceholder theme={{ mode: theme.mode, primaryColor: theme.primaryColor }} />
			</ChoiceCircle>
