			...
			<DropdownV2
				dropdownList={[
					...
					},
					{
						type: 'children',
						children: (
							<ScrollContainer maxHeight='350px' key={'notificationScrollContainer'}>
								{notificationItems}
							</ScrollContainer>
						),
					},
...
const StyledNotification = styled('div')`
	& .notification-item {
		...
		border-bottom-color: ${({ theme }) =>
			theme.mode === 'dark' ? 'rgba(219, 219, 219, 17%)' : 'rgb(219, 219, 219, 67%)'};
	}

	& .notification-item:hover {
		background: ${({ theme }) =>
			theme.mode === 'dark' ? 'rgba(255, 255, 255, 10%)' : 'rgb(221 221 221 / 50%)'};
	}
