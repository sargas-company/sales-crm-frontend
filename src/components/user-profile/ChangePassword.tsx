...
const ChangePassword = () => {
	...
	const handleSubmit = useCallback(() => {
		...
		if (!currentPassword) {
			handleError('currentPassword', 'Current passwrod must be at least 8 characters')
		}
		if (!newPassword) {
			...
			<Form autcomplete='OFF' onSubmit={handleSubmit} preventDefault>
				<GridInnerContainer spacing={1.6}>
					<GridItem xs={12} md={6}>
						...
						/>
						{errors.currentPassword ? <InputErrorMsg msg={errors.currentPassword} /> : ''}
					</GridItem>
					<GridItem xs={12} md={6}>
						<TextField
							name='newPassword'
						...
						/>
						{errors.newPassword ? <InputErrorMsg msg={errors.newPassword} /> : ''}
					</GridItem>
					<GridItem xs={12} md={6}>
						<TextField
						...
						/>
						{errors.confirmPassword ? <InputErrorMsg msg={errors.confirmPassword} /> : ''}
					</GridItem>
					<GridItem xs={12}>
						<PasswordRequirement />
					</GridItem>
