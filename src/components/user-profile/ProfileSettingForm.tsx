		...
		<Card padding='1.4rem'>
			<Form>
				<Box display='flex' space={1} align='center' mb={32}>
					{props.avatar ? (
						<Avatar src={props.avatar} alt='john doe' size={120} ref={avatarRef} />
					) : (
						''
					)}
				...
				<GridInnerContainer spacing={1.4}>
					...
					<GridItem xs={12} md={6}>
						<Select label='Country' width='100%' defaultValue={props.country || 'nepal'}>
					...
					<GridItem xs={12} md={6}>
						<Select label='Language' width='100%' defaultValue={props.language || 'nepali'}>
					...
					<GridItem xs={12} md={6}>
						<Select label='Currency' width='100%' defaultValue={props.currency || 'NPR'}>
