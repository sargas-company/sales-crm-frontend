	...
	return (
		<Card padding='1.4rem'>
			<Box display='flex' flexDirection='column' space={1.6}>
				...
				>
					<Text varient='body1' weight='bold' color='warning' lineHeight='30px' paragraph>
				...
				<Box>
					<GridInnerContainer columnSpacing={1.6} rowSpacing={{ xs: 1, md: 0.4 }}>
						<GridItem xs={12} md={6}>
							<TextField
					...
					/>
					<Button styles={{ marginTop: 8, display: 'flex' }}>Change password</Button>
				</Box>
			</Box>
		</Card>
	)
