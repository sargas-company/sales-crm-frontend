...
import type { ProposalItem, NewItemHandle } from "./type";

const itemId = (item: Array<ProposalItem>) => {
...
const AddNewItem = forwardRef<NewItemHandle, ItemPros>((props, ref) => {
  const [items, setItems] = useState<Array<ProposalItem>>(
...
export interface ItemDetail extends ProposalItem {
  handleChange: (
    id: number,
