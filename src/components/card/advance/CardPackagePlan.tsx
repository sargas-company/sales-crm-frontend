	...
	return (
		<Card>
			...
			<Box display='flex' flexDirection='column' px={20} space={0.8} pb={20}>
				<Text varient='caption' lineHeight='20px' weight='medium' secondary paragraph>
					Please make the payment to start enjoying all the features of our premium plan as
					soon as possible.
				</Text>
				<ColorBox
					padding={12}
					...
					borderRadius='6px'
				>
					<CustomAvatar varient='rounded' skin='light' color='info' size={40} fontSize={25}>
						<BusinessCenter />
					</CustomAvatar>
					<Box display='flex' align='center' wrap='wrap' justify='space-between' space={0.5}>
						<Box>
				...
				<TextField name='email-address' type='text' label='email address' sizes='small' />
...
const CreaditLists: FC<{
	...
	<Box display='flex' align='center' space={0.8}>
		...
		<Box display='flex' align='center' wrap='wrap' justify='space-between' space={0.3} flex={1}>
			<Box>
