...
const formatData = (logo: string, label: string, tag: string, total: number) => ({
	logo,
	label,
	tag,
	total,
...
const desposits = [
	formatData('https://i.ibb.co/qkxNynH/google.png', 'Google Adsense', 'Paypal deposit', 453),
	formatData(
	...
	formatData('https://i.ibb.co/6bjxdZp/digital-ocean.png', 'Digital Ocean', 'Cloud Hosting', 234),
	formatData('https://i.ibb.co/drvxnms/aws.png', 'AWS account', 'Choosing a Cloud Platform', 4453),
]
