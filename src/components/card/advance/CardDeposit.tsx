...
const desposits = [
	formatData('https://i.ibb.co/nbr4npc/gumroad.png', 'Gumroad Account', 'Sell UI Kit', 43453),
	formatData(
	...
	formatData('https://i.ibb.co/hFTkBsc/stripe.png', 'Stripe', 'Android Application', 1299),
	formatData(
	...
	formatData('https://i.ibb.co/kBJSqG4/citi-bank.png', 'Bank Account', 'Wallet desosit', 4453),
]
