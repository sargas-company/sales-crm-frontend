		...
		<Card className='overflow-hidden'>
			...
			<Box padding={20}>
				...
				<Box display='flex' justify='space-between'>
					<MeetupStatus title='Interested' icon={<Icon icon='mdi:star-outline' />} />
					<MeetupStatus title='Joined' icon={<Icon icon='mdi:check-circle-outline' />} />
					<MeetupStatus
						title='Invited'
						icon={<Icon icon='mdi:account-outline' />}
						classes='text-primary'
					/>
					<MeetupStatus title='More' icon={<Icon icon='mdi:dots-horizontal' />} />
				</Box>
