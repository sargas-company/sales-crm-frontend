...
import { removeEmail, readEmail, moveToSpam } from '../../../features/emails/creator'
import {
	DeleteOutline,
	DraftsOutlined,
	MarkunreadOutlined,
...
const ItemActions: FC<Props> = ({ id, isRead }) => {
	...
	return (
		<Box display='flex' className='item-actions-container' onClick={handlePropagation}>
			<IconButton
				varient='text'
				contentOpacity={6}
				size={40}
			...
			<IconButton varient='text' contentOpacity={6} size={40} fontSize={24} onClick={handleRead}>
