...
import { DeleteOutline, MailOutlineRounded, MoreVert, Star, StarOutline } from '@mui/icons-material'
	...
	return (
		...
		>
			<Box display='flex' flex={1}>
				...
				<ToolbarButton icon={<MailOutlineRounded />} handleClick={onMailReadChange} />
				<Folders onRemoveMultiple={onMailRemove} onMoveToSpam={onMailMoveToSpam} />
