...
import { changeUserStatus } from '../../../../store/chats/chatSlice'
...
const CurrentUserProfile: FC<Props> = ({ handleCloseModal, show }) => {
	...
	return (
		<ChatModal>
			<ProfileLayout direction='left' shouldShow={show} handleCloseModal={handleCloseModal}>
				<ProfileAvatar {...data} />
				<ScrollContainer maxHeight='56vh' px={20} py={20}>
					<ProfileAbout about={data.about} />
					<ChangeStatus status={data.status} onChangeStatus={onChangeUserStatus} />
					<UserOptions />
