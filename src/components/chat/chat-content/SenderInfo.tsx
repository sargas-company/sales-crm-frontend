...
const SenderInfo = () => {
	...
	return (
		<Box display='flex' align='center' px={16} py={12} space={0.8} className='zIndex-2'>
			...
			>
				...
				<Box display='flex' flexDirection='column' justify='flex-start'>
					...
					<Text varient='caption' weight='medium' textOverflow='ellipsis' secondary>
						{role}
					</Text>
				</Box>
			</Box>
			<ContactProfile shouldShow={showModal} handleCloseModal={toggleShowModal} />
		</Box>
	)
}
