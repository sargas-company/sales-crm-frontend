import { PhoneOutlined, VideocamOutlined, Search, MoreVert } from '@mui/icons-material'
...
const ToolButton = ({ icon, fontSize }: { icon: ReactElement; fontSize?: number }) => (
	<IconButton varient='text' size={34} fontSize={fontSize ? fontSize : 21} contentOpacity={8}>
		{icon}
	</IconButton>
)
