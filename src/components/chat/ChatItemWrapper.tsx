...
const selectSelectedChatId = (state: RootState) => state.chat.selectedChat?.profile.uid
	...
	return (
		<StyledWrp
			...
			className={`${isActiveMatch ? 'active-chat' : ''} ${
				mode.name === 'dark' ? 'theme-dark-active-fade-hover' : 'theme-light-active-fade-hover'
			}`}
			display='flex'
			align='center'
			padding={12}
