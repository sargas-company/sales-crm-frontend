...
const PaymentMethods = lazy(() => import('../../../components/users/payment/PaymentMethods'))
const CurrentPlan = lazy(() => import('../../../components/users/plans/CurrentPlan'))
const BillingAddress = lazy(() => import('../../../components/users/billlings/BillingAddress'))
const BillAndPlan = () => {
