...
const ReadEmail = () => {
	const currentOpenMail = useAppSelector((state) => state.email.currentOpenMail)
	...
	const { subject, labels, from, timestamp, message, attachments, id, isStarred } = currentOpenMail
	return (
						...
						>
							<Box display='flex' align='center' justify='space-between' wrap='wrap'>
								...
								<Box display='flex' align='center'>
									...
									<ContentAction hasAttachments={attachments.length > 0 ? true : false} />
								</Box>
							</Box>
